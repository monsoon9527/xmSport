 ...
 */
export function processData(step: number, jsonTemplate?: string): string {
  // 步数值校验
 ...
 * @returns {string} 处理后的数据JSON字符串
 */
function processExistingTemplate(step: number, jsonTemplate: string): string {
  // 计算距离/卡路里（成年女性近似）
